...
# region Example 2: Simply Supported Beam with Overhang and Point Moment
E, I = symbols('E, I')
R1, R2 = symbols('R1, R2')
b2 = Beam(30, E, I)
...
# endregion
# region Example 3: Beam with Variable Elastic Modulus / Moment of Inertia
E, I = symbols('E, I')
R1, R2 = symbols('R1, R2')
b3 = Beam(3, E, I)
...
# endregion
# region Example 4: Fixed-Fixed Beam with Linear (Ramp) Load
E, I = symbols('E, I')
...
# endregion
# region Example 5: Propped Cantilever with Parabolic Distributed Load
E, I = symbols('E, I')
...
# endregion
# region Example 6: Continuous Beam over Multiple Supports
E, I = symbols('E, I')
...
# endregion
# region Example 7: Beam with Internal Pin Joint (Hinge)
E, I = symbols('E, I')
R1, M1, R2 = symbols('R1, M1, R2')
b7 = Beam(8, E, I)
...
# region Example 13: Beam with Sliding Hinge (Internal Roller/Guide)
# %%
