...
help(concrete_rectangular_section)
# %% [markdown]
# ### Create Geometry
#
...
# %% create the geometry
help(concrete_rectangular_section)
d=600; b=300; dia_top=16; area_top=200; n_top=3; c_top=32; dia_bot=20; area_bot=310; n_bot=3; c_bot=42; dia_side=12; area_side=110; n_side=3; c_side=57; n_circle=16; conc_mat=concrete; steel_mat=steel
...
geom.plot_geometry(title="Concrete Section")
# %% [markdown]
